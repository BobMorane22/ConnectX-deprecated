...
private:
    ...
    const bool m_precisionNeeded{false}; ///< Specifies if precision higher than seconds is needed.

    const TimePrecision m_precision {TimePrecision::SECONDS}; ///< The time precision to use.
